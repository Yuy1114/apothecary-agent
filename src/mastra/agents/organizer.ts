...
## 目标骨架（dest 的根，二选一放对层）
notes/（原子笔记，**严格平铺、不建子文件夹**，主题变标签） · journal/（日记/日志，按日期） · areas/（无限期领域：career/finance/health/home） · projects/（有终点的事，YYYY-项目名/） · resources/（外部参考：books/clippings/code） · records/（档案原件：账单/合同/证件/病历，敏感） · media/（screenshots/attachments/photos） · archive/（冷存/派生/垃圾）
